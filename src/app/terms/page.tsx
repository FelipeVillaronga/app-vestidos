  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 min-h-[calc(100vh-8rem)]">
      <h1 className="text-2xl sm:text-3xl font-bold">
        Rental Terms and Conditions – GlamRent
      </h1>

      <p className="mt-6 text-slate-600 dark:text-slate-400">
        Welcome to GlamRent. Before using our garment rental service, we ask
        that you carefully read the following terms and conditions. By using our
        platform, you agree to comply with these rules.
      </p>
